    ...
    <div id="navbarContent" class="m-0 p-0 justify-content-end align-self-center">
        <div class="nav-item dropdown m-0 p-0">
            ...
            <div class="dropdown-menu dropdown-menu-right " aria-labelledby="my_account">
                <div class="d-flex"><img src="../assets/pass.svg" class="pl-4"><router-link to="/connexion" class="dropdown-item pl-2">Connexion</router-link></div>
                <div class="d-flex"><img src="../assets/mail.svg" class="pl-4"><router-link to="/inscription" class="dropdown-item pl-2">Inscription</router-link></div>
            </div>
        </div>
    </div>
</template>
