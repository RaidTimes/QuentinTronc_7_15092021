<template>
    <div id="modalModifyMessage" tabindex="-1" aria-labelledby="modalModifyMessage" aria-hidden="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <form enctype="multipart/form-data">
                    <div class="modal-header d-flex flex-column flex-md-row align-items-center justify-content-start">
                        <p class="modal-title h5 mr-1">Modifier le message</p>
                        <p class="modal-title mt-1" :class="modifyColor">{{modifyTag}}</p>
                    </div>
                    <div class="row modal-body">
                        <div class="col-12 justify-content-center form-group">
                            <label for="modifyMessage" class="sr-only">Message :</label>
                            <textarea class="form-control" v-model="modifyMessage" id="modifyMessage" name="message" rows="10" placeholder="Votre message ici..."></textarea>
                        </div>
                    ...
                    <div class="modal-footer">
                        <div class="row w-100 justify-content-spacebetween">
                            ...
                            <div class="col-6"><button type="submit" @click.prevent="updateMessage()" class="btn btn-success btn-block">Confirmer</button></div>
                        </div>
                    </div>
                </form>
            </div>
...
export default {
    ...
    methods: {
        ...
        updateMessage() {
            ...
            formData.set("message", this.modifyMessage.toString())
    ...
    beforeMount () {
        ...
        .then(res => {
            ...
            if (this.modifyUserId == localStorage.getItem("userId"))  {
                this.modifyTag = "( Utilisateur : " + res.data.userName + " )"
                this.modifyMessage = res.data.message
