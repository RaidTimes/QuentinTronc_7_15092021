                    ...
                    <div class="card bg-light my-3">
                        <div class="card-header bg-light d-flex align-items-center justify-content-between m-0 p-1">
                            ...
                            <div :id="'adus' + oneMessage.id" v-if="oneMessage.userId == this.currentUserId || this.isAdmin == 'true'">
                                <a :href="'#/message/modify/' + oneMessage.id"><img src="../assets/modify.svg" class="m-1 p-0" alt="Modifier le message" title="Modifier le message"/></a>
                                <a :href="'#/message/delete/' + oneMessage.id"><img src="../assets/delete.svg" class="m-1 p-0" alt="Supprimer le message" title="Supprimer le message"/></a>
                            </div>                               
                        </div>
                                ...
                                <form enctype="multipart/form-data">
                                    ...
                                    <div class="row modal-body">
                                        <div class="col-12 justify-content-center form-group">
                                            ...
                                            <div v-show="submitted && !newComment" class="invalid-feedback">Un commentaire est requis !</div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <div class="row w-100 justify-content-spacebetween">
                                            <div class="col-6"><a data-dismiss="modal" class="btn btn-secondary btn-block">Annuler</a></div>
                                            <div class="col-6"><button type="submit" @click.prevent="addNewComment()" class="btn btn-success btn-block">Confirmer</button></div>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="card-header align-items-center m-0 p-1">
                            <div class="d-flex justify-content-between">
                                ...
                                <div :id="'adcom' + comment.id"  v-if="comment.UserId == this.currentUserId || this.isAdmin == 'true'">
                                    <a :href="'#/commentaire/modify/' + comment.id"><img src="../assets/modify.svg" class="m-1 p-0" alt="Modifier le message" title="Modifier le message"/></a>
                                    <a :href="'#/commentaire/delete/' + comment.id"><img src="../assets/delete.svg" class="m-1 p-0" alt="Supprimer le message" title="Supprimer le message"/></a>
                                </div>
                            </div>
