            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="card bg-light">
                        <p class="h5 my-3 text-center" style="color:#091F43;">Bienvenu sur le réseau social interne Groupomania</p>
                        ...
                        <div class="card-body col-md-8 col-lg-6 offset-md-2 offset-lg-3">
                            <form @submit.prevent="handleSubmit">
                                ...
                                <button class="btn btn-outline-primary btn-sm btn-block">S'incrire</button>
                            </form>
                        </div>
                        <div class="card-footer bg-light">
                            <span class="text-dark">Déjà membre ?<router-link to="/connexion">Connexion</router-link> !</span>
                        </div>
                    </div>
                </div>
            </div>
