                                ...
                                <form enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer">
                                        <div class="row w-100 justify-content-spacebetween">
                                            ...
                                            <div class="col-6"><button type="submit" @click.prevent="addNewMessage()" class="btn btn-outline-success btn-block">Confirmer</button></div>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div v-for="message in messages" :key="message.id" class="card bg-light my-3">
                        <div class="card-header bg-light d-flex align-items-center justify-content-between m-0 p-1">
                            ...
                            <div v-if="message.UserId == this.currentUserId || this.isAdmin == 'true'">
                                <a :href="'#/message/modify/' + message.id"><img src="../assets/modify.svg" class="m-1 p-0" alt="Modifier le message" title="Modifier le message"/></a>
                                <a :href="'#/message/delete/' + message.id"><img src="../assets/delete.svg" class="m-1 p-0" alt="Supprimer le message" title="Supprimer le message"/></a>
                            </div>
                        </div>
